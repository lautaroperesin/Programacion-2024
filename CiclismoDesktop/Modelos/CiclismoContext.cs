...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdVenta).IsClustered(false);

            entity.Property(e => e.IdVenta).HasColumnName("ID Venta");
            entity.Property(e => e.CasillaPostal)
                .HasMaxLength(50)
                .HasColumnName("Casilla Postal");
            entity.Property(e => e.EmpresaEnvio)
                .HasMaxLength(20)
                .HasColumnName("Empresa envio");
            entity.Property(e => e.FechaAtencionSolicitada)
                .HasColumnType("smalldatetime")
                .HasColumnName("Fecha atencion solicitada");
            entity.Property(e => e.FechaDespacho)
                .HasColumnType("smalldatetime")
                .HasColumnName("Fecha despacho");
            entity.Property(e => e.FechaPedido)
                .HasColumnType("smalldatetime")
                .HasColumnName("Fecha pedido");
            entity.Property(e => e.IdCliente).HasColumnName("ID cliente");
            entity.Property(e => e.IdEmpleado).HasColumnName("ID empleado");
            entity.Property(e => e.PagoRecibido).HasColumnName("Pago recibido");
